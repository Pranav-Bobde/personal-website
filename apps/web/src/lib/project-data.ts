...
export const projects: Project[] = [
  {
    ...
    description:
      "A minimal, keyboard-navigable personal website built with Next.js and Tailwind CSS.",
    role: "Developer",
  ...
  },
  {
    ...
    title: "Task Manager",
    description:
      "A productivity app for managing tasks with advanced filtering and sorting capabilities.",
    role: "Lead Developer",
  ...
  },
  {
    ...
    title: "Code Editor",
    description:
      "A lightweight browser-based code editor with syntax highlighting and live preview.",
    role: "Creator",
